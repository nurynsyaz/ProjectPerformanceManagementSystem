    ...
    <div class="title-container">
        <div class="reset-container">
            ...
            <form action="ResetPasswordHandlerServlet" method="post">
                ...
                <div class="mb-3">
                    <label for="passwordHint" class="form-label">New Password Hint</label>
                    <input type="text" class="form-control" name="passwordHint" id="passwordHint" placeholder="e.g., your favorite food" required>
                </div>
